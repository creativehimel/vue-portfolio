...
const features = [
  {
    ...
    title: "Web Design",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident abnulla quod dignissimos vel non corrupti doloribus voluptatum eveniet",
  },
  {
    id: 2,
  ...
  <section class="bg-white dark:bg-gray-900">
    <div id="feature" class="container px-6 py-10 mx-auto">
      ...
      >
        ...
        >
          <span
            class="inline-block px-4 py-2 text-blue-500 bg-blue-100 rounded-full dark:text-white dark:bg-blue-500"
          >
            {{ feature.id }}
          </span>
